...
import math
import sys
from PyQt4.QtCore import (QDate, QRectF, QString, Qt)
...
class Form(QDialog):
    ...
    def create_widgets(self):
        ...
        self.cursorButton = QPushButton("Print via Q&Cursor")
        self.htmlButton = QPushButton("Print via &HTML")
        self.painterButton = QPushButton("Print via Q&Painter")
        self.quitButton = QPushButton("&Quit")


    def layout_widgets(self):
        buttonLayout = QHBoxLayout()
        buttonLayout.addWidget(self.cursorButton)
        buttonLayout.addWidget(self.htmlButton)
        buttonLayout.addWidget(self.painterButton)
    ...
    def create_connections(self):
        self.cursorButton.clicked.connect(self.printViaQCursor)
        self.htmlButton.clicked.connect(self.printViaHtml)
        self.painterButton.clicked.connect(self.printViaQPainter)
