...
import random
import sys
from PyQt4.QtCore import (QObject, QPointF, QRectF, QTimer, Qt)
...
from PyQt4.QtGui import (QApplication, QBrush, QColor, QDialog,
        ...
        QVBoxLayout, QStyleOptionGraphicsItem)
...
class Head(QGraphicsItem):
    ...
    def paint(self, painter, option, widget=None):
        ...
        levelOfDetail = QStyleOptionGraphicsItem.levelOfDetailFromTransform(
