...
class Form(QDialog):
    ...
    def create_widgets(self):
        ...
        self.formatButton1 = QPushButton("Set Number Format... (&Modal)")
        self.formatButton2 = QPushButton("Set Number Format... (Modele&ss)")
        self.formatButton3 = QPushButton("Set Number Format... (`&Live')")


    def layout_widgets(self):
        buttonLayout = QHBoxLayout()
        buttonLayout.addStretch()
        buttonLayout.addWidget(self.formatButton1)
        buttonLayout.addWidget(self.formatButton2)
        buttonLayout.addWidget(self.formatButton3)
        layout = QVBoxLayout()
    ...
    def refreshTable(self):
        ...
        for x in range(self.X_MAX):
            for y in range(self.Y_MAX):
                self.refreshItem(x, y)


    def refreshItem(self, x, y):
